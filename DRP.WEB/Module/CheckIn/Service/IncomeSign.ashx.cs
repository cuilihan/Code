...
namespace DRP.WEB.Module.CheckIn.Service
{
    ...
    /// 非订单收入登记 
    /// </summary>
    public class IncomeSign : HandlerBase
    {
        ...
        {
            var qry = new IncomeCheckInCriteria();
            ...
            qry.IncomeDate = dateScope;
            qry.IncomeTypeID = context.Request["TypeID"];
            ...
            var total = 0;
            var list = new IncomeCheckIn_BF().QueryData(qry, out total);
        ...
        private void Delete(HttpContext context)
        {
            ...
            else
            {
                ...
                var isOk = new IncomeCheckIn_BF().Delete(list);

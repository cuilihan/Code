...
namespace DRP.WEB.Module.Fin
{
    public partial class TeamOrderList : Pagebase
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            list.Add(new NExcelCellFormat(5, "SupplierName", "供应商", NExcelCellFormatStyle.Normal));
            ...
            list.Add(new NExcelCellFormat(6, "GuideName", "导游", NExcelCellFormatStyle.Normal));

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payable.aspx.cs" Inherits="DRP.WEB.Module.Fin.Payable" %>
...
<head runat="server">
    ...
    <script src="Script/Payable.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        <div id="tabs" class="easyui-tabs">
            <div title="付款管理" runat="server" id="orderTitle" iconcls="icon-reload">
                <div id="toolbar">
                    ...
                    <span style="padding-left: 1em;">应付款金额：</span>
                    <asp:TextBox ID="txtPayAmt" ClientIDMode="Static" Width="120" runat="server"></asp:TextBox>

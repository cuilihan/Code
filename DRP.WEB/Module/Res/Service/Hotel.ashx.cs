...
namespace DRP.WEB.Module.Res.Service
{
    ...
    /// 酒店管理
    /// </summary>
    public class Hotel : HandlerBase
    {
        ...
        private void QueryResource(HttpContext context)
        {
            ...
            var total = 0;
            var dt = new Hotel_BF().QueryData(qry, out total);
        ...
        private void DeleteResource(HttpContext context)
        {
            ...
            else
            {
                ...
                var isOk = new Hotel_BF().Delete(listID);
        ...
        {
            DAL.Res_Hotel entity = new DAL.Res_Hotel();
            ...
            entity.StarLv = context.Request["StarLv"];
            entity.Price = context.Request["Price"];
            ...
            var isOk = new Hotel_BF().Save(entity, list, fileID);
            context.Response.Write(isOk ? "1" : "0");
        }
        ...
        private void QueryHotelTile(HttpContext context)
        {
            var routeTypeID = context.Request["routeTypeID"];
            var list = new Hotel_BF().QueryData(routeTypeID);//酒店
            ...
            if (string.IsNullOrEmpty(str))
                str = "<tr><td><div class='icon_sad'>无酒店信息</div></td></tr>";

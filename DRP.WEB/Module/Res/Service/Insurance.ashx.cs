...
namespace DRP.WEB.Module.Res.Service
{
    ...
    ///  保险公司管理
    /// </summary>
    public class Insurance : HandlerBase
    {
        ...
        private void QueryResource(HttpContext context)
        {
            ...
            var total = 0;
            var dt = new Insurance_BF().QueryData(qry, out total);
        ...
        private void DeleteResource(HttpContext context)
        {
            ...
            else
            {
                ...
                var isOk = new Insurance_BF().Delete(listID);
        ...
        {
            DAL.Res_Insurance entity = new DAL.Res_Insurance();
            ...
            var isOk = new  Insurance_BF().Save(entity, list);
            context.Response.Write(isOk ? "1" : "0");
        }
        ...
        protected override string GetNavigateID(HttpContext context)
        {
            ...
            return xType == 1 ? "insurerqry" : "insurer";
        }   
    }
}
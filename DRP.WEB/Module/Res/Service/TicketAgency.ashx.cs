...
namespace DRP.WEB.Module.Res.Service
{
    ...
    /// 票务机构
    /// </summary>
    public class TicketAgency : HandlerBase
    {
        ...
        private void QueryResource(HttpContext context)
        {
            ...
            var total = 0;
            var dt = new TicketAgency_BF().QueryData(qry, out total);
        ...
        private void DeleteResource(HttpContext context)
        {
            ...
            else
            {
                ...
                var isOk = new TicketAgency_BF().Delete(listID);
        ...
        {
            DAL.Res_TicketAgency entity = new DAL.Res_TicketAgency();
            ...
            entity.TicketType=context.Request["TicketType"];
            ...
            var isOk = new TicketAgency_BF().Save(entity, list);
            context.Response.Write(isOk ? "1" : "0");
        }
        ...
        protected override string GetNavigateID(HttpContext context)
        {
            ...
            return xType == 1 ? "ticketqry" : "ticket";
        }
    }
}
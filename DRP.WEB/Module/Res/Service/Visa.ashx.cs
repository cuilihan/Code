...
namespace DRP.WEB.Module.Res.Service
{
    ...
    public class Visa : HandlerBase
    {
        ...
        private void QueryResource(HttpContext context)
        {
            ...
            var total = 0;
            var dt = new Visa_BF().QueryData(qry, out total);
        ...
        private void DeleteResource(HttpContext context)
        {
            ...
            else
            {
                ...
                var isOk = new Visa_BF().Delete(listID);
        ...
        {
            DAL.Res_Visa entity = new DAL.Res_Visa();

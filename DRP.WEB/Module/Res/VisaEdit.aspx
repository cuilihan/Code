<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisaEdit.aspx.cs" Inherits="DRP.WEB.Module.Res.VisaEdit" %>
...
<head runat="server">
    ...
    <script src="Script/VisaEdit.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        <asp:Panel runat="server" ID="pnlContainer" Style="padding: 10px;">
            <table class="tblInfo">
                <tr>
                    <td class="rowlabel"><span class="red">*</span>签证机构名称：
                    </td>
                    <td colspan="3">
                ...
                <tr>
                   ...
                   <tr>
                    ...
                    <td class="rowlabel">微信号：
                    </td>
                    <td>
                        <asp:TextBox ID="Wechat" runat="server" ClientIDMode="Static"></asp:TextBox>
                    </td>
                    <td class="rowlabel"> 
                    </td>
                    <td>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td colspan="5">
                        <asp:TextBox ID="BizType" Width="90%" runat="server" ClientIDMode="Static"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                 ...
                 <tr>
                    <td class="rowlabel">银行账号信息：
                    </td>
                    <td colspan="5">
                        <asp:TextBox ID="BankInfo" Width="90%" runat="server" ClientIDMode="Static"></asp:TextBox>
                    </td>
                </tr>
                <tr>

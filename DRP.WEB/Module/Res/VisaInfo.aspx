<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisaInfo.aspx.cs" Inherits="DRP.WEB.Module.Res.VisaInfo" %>
        ...
        <asp:Panel runat="server" ID="pnlContainer" Style="padding: 10px;">
            <table class="tblInfo">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Literal ID="Wechat" runat="server"></asp:Literal>
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <asp:Literal ID="BankInfo" runat="server"></asp:Literal>
                    </td>
                </tr>
                <tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherResEdit.aspx.cs" Inherits="DRP.WEB.Module.Res.OtherResEdit" %>
...
<head runat="server">
    ...
    <script src="Script/OtherEdit.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
       <asp:Panel runat="server" ID="pnlContainer" Style="padding: 10px;">
            <table class="tblInfo">
                <tr>
                    <td class="rowlabel"><span class="red">*</span>资源名称：
                    </td>
                    <td colspan="3">

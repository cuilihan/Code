<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MotorcadeEdit.aspx.cs" Inherits="DRP.WEB.Module.Res.MotorcadeEdit" %>
...
<head runat="server">
    ...
    <script src="Script/MotorcadeEdit.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        <asp:Panel runat="server" ID="pnlContainer" Style="padding: 10px;">
            <table class="tblInfo">
                <tr>
                    <td class="rowlabel"><span class="red">*</span>车队地区：</td>
                    <td colspan="5">
                        <asp:DropDownList ID="DepartureID" ClientIDMode="Static" AppendDataBoundItems="true" runat="server">
                            <asp:ListItem Text="请选择" Value=""></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td class="rowlabel"><span class="red">*</span>车队名称：
                    </td>
                    <td>
                        <asp:TextBox ID="Name" ClientIDMode="Static" runat="server" data-options="required:true"></asp:TextBox>
                    </td>
                    <td class="rowlabel">车队规模：
                    </td>
                    <td>
                        <asp:DropDownList ID="Scale" ClientIDMode="Static" runat="server" AppendDataBoundItems="true">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsurerEdit.aspx.cs" Inherits="DRP.WEB.Module.Res.InsurerEdit" %>
...
<head runat="server">
    ...
    <script src="Script/InsurerEdit.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        <asp:Panel runat="server" ID="pnlContainer" Style="padding: 10px;">
            <table class="tblInfo">
                <tr>
                    <td class="rowlabel"><span class="red">*</span>保险公司名称：
                    </td>
                    <td colspan="3">

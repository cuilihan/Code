...
var t = {
    ...
    serverUrl: "Service/Resource.ashx?rnd=" + getRand() + "&resID=" + request("id"),
    fnBindData: function () {
        $('#tblData').datagrid({
            loadMsg: "正在加载数据...",
            ...
            columns: [[
                        ...
                        { field: 'OrderCost', title: '订单成本', sortable: true, sortName: "OrderCost", width: 80, align: 'right' },
                        {

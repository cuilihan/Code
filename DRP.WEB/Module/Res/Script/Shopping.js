...
var t = {
    ...
    serverUrl: "Service/Shopping.ashx?rnd=" + getRand(),
    fnBindData: function () {
        $('#tblData').datagrid({
            loadMsg: "正在加载数据...",
            ...
            frozenColumns: [[
                ...
                {
                    field: 'Name', title: '购物店名称', width: 180, sortable: true, sortName: "Name", formatter: function (val, rec) {
            ...
            columns: [[ 
                ...
                { field: 'Phone', title: '电话', width: 120, sortable: true, sortName: "Phone" },
    ...
    fnEdit: function (id) {
        var title = "购物店维护";
        var url = "ShoppingEdit.aspx?id=" + id;
        addTab(title, url, function () { t.fnBindData(); });
    },
    fnInfo: function (id) {
        var title = "查看购物店信息";
        var url = "ShoppingInfo.aspx?id=" + id;

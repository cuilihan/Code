<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hotel.aspx.cs" Inherits="DRP.WEB.Module.Res.Hotel" %>
...
<body>
    <form id="form1" runat="server">
        <div id="tabs" class="easyui-tabs">
            <div title="酒店管理" iconcls="icon-search">
                <div id="toolbar">
                    区域： 
                    ...
                    <a id="btnAdd" class="easyui-linkbutton" iconcls="icon-add">新增酒店</a>

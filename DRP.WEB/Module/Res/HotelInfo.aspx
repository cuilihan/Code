<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HotelInfo.aspx.cs" Inherits="DRP.WEB.Module.Res.HotelInfo" %>
        ...
        <asp:Panel runat="server" ID="pnlContainer" Style="padding: 10px;">
            <table class="tblInfo">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Literal ID="StarLv" runat="server"></asp:Literal>
                    </td>

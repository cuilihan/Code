<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScenicSpotEdit.aspx.cs" Inherits="DRP.WEB.Module.Res.ScenicSpotEdit" %>
...
<head runat="server">
    ...
    <script src="Script/ScenicSpotEdit.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        <asp:Panel runat="server" ID="pnlContainer" Style="padding: 10px;">
            <table class="tblInfo">
                <tr>
                    <td class="rowlabel"><span class="red">*</span>地区：</td>
                    <td colspan="5">
                ...
                <tr>
                    <td class="rowlabel"><span class="red">*</span>名称：
                    </td>
                    <td colspan="3">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="NormalPrice"  runat="server" ClientIDMode="Static"></asp:TextBox>
                    </td>
                     <td class="rowlabel">团队价：
                    </td>
                    <td>
                        <asp:TextBox ID="TeamPrice"  runat="server" ClientIDMode="Static"></asp:TextBox>
                    </td>
                     <td class="rowlabel">合作价：
                    </td>
                    <td>
                        <asp:TextBox ID="CooperatePrice"  runat="server" ClientIDMode="Static"></asp:TextBox>
                    </td>
                </tr>
                <tr>

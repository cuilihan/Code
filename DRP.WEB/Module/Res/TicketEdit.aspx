<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TicketEdit.aspx.cs" Inherits="DRP.WEB.Module.Res.TicketEdit" %>
...
<head runat="server">
    ...
    <script src="Script/TicketEdit.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        <asp:Panel runat="server" ID="pnlContainer" Style="padding: 10px;">
            <table class="tblInfo">
                <tr>
                    <td class="rowlabel"><span class="red">*</span>票务机构名称：
                    </td>
                    <td>
                        <asp:TextBox ID="Name" ClientIDMode="Static" runat="server" data-options="required:true"></asp:TextBox>
                    </td>
                    <td class="rowlabel">票务类型：
                    </td>
                    <td id="t">
                        <asp:CheckBoxList ID="TicketType" ClientIDMode="Static" RepeatDirection="Horizontal" runat="server">
                            <asp:ListItem Text="机票" Value="机票"></asp:ListItem>
                            <asp:ListItem Text="船票" Value="船票"></asp:ListItem>
                            <asp:ListItem Text="火车票" Value="火车票"></asp:ListItem>
                            <asp:ListItem Text="门票" Value="门票"></asp:ListItem>

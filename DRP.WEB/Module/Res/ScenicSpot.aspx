<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScenicSpot.aspx.cs" Inherits="DRP.WEB.Module.Res.ScenicSpot" %>
...
<head runat="server">
    ...
    <script src="Script/ScenicSpot.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        <div id="tabs" class="easyui-tabs">
            <div title="景点门票机构管理" iconcls="icon-search">
                <div id="toolbar">
                    区域： 
                    ...
                    <a id="btnAdd" class="easyui-linkbutton" iconcls="icon-add">新增</a>

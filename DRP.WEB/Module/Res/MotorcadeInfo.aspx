<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MotorcadeInfo.aspx.cs" Inherits="DRP.WEB.Module.Res.MotorcadeInfo" %>
       ...
       <asp:Panel runat="server" ID="pnlContainer" Style="padding: 10px;">
            <table class="tblInfo">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Literal ID="Scale" runat="server"></asp:Literal>
                    </td>

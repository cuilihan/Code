<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DestinationEdit.aspx.cs" Inherits="DRP.WEB.Module.Glo.DestinationEdit" %>
...
<body>
   ...
   <asp:Panel runat="server" ID="pnlContainer">
            <table class="tblEdit">
                <tr>
                    <td class="rowlabel">上级目的地名称：
                    </td>
                    <td>
                        <asp:Literal ID="lblParnetName" runat="server"></asp:Literal>
                    </td>
                </tr>
                <tr>
                    <td class="rowlabel"><span class="red">*</span>目的地名称：
                    </td>
                    <td>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BasicInfoEdit.aspx.cs" Inherits="DRP.WEB.Module.Glo.BasicInfoEdit" %>
    ...
    <form id="form1" runat="server">
     <asp:Panel runat="server" ID="pnlContainer">
            <table class="tblEdit">
                ...
                <tr>
                    <td class="rowlabel"><span class="red">*</span>参数名称：
                    </td>
                    <td>

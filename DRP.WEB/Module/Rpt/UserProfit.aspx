<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserProfit.aspx.cs" Inherits="DRP.WEB.Module.Rpt.UserProfit" %>
...
<head runat="server">
    ...
    <script src="Script/UserProfit.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        <div id="tabs" class="easyui-panel" title="员工业务统计" iconcls="icon-search" style="padding: 6px 30px 10px 6px;">
            <div id="rptBatch">
                <table class="tblInfo">
                    <tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tOrderInfo.aspx.cs" Inherits="DRP.WEB.Module.Order.tOrderInfo" %>
...
<body style="margin: 0 auto; background-color: #EEEEEE; color: #000 !important">
    <form id="form1" runat="server">
        ...
        <asp:Panel ClientIDMode="Static" ID="pnlWraper" CssClass="wrapper" runat="server" Style="padding: 1mm 15mm">
            <!--start print-->

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TicketOrder.aspx.cs" Inherits="DRP.WEB.Module.Order.TicketOrder" %>
            ...
            <div title="机票订单管理" runat="server" id="orderTitle" iconcls="icon-reload">
                <div id="toolbar">
                    <div style="margin-bottom: 5px;">
                        ...
                        <span style="padding-left: 1em;">联系人公司名称：</span><asp:TextBox ID="txtCompany" Width="90" ClientIDMode="Static" runat="server"></asp:TextBox>
                    ...
                    <div>
                        ...
                        <asp:DropDownList ID="ddlOrderStatus" Width="100" ClientIDMode="Static" AppendDataBoundItems="true" runat="server">
                            ...
                            <asp:ListItem Text="正常订单" Value="2"></asp:ListItem>
                        ...
                        <asp:TextBox ID="eUnCollectedAmt" Width="90" ClientIDMode="Static" runat="server"></asp:TextBox>
                            ...
                            <asp:LinkButton ID="btnAdd" CssClass="easyui-linkbutton" iconcls="icon-add" ClientIDMode="Static" runat="server">新增机票订单</asp:LinkButton>
                            <a class="easyui-linkbutton" id="A1" iconcls="icon-add" onclick="o.fnBatchInvoice()">合并订单开票</a>

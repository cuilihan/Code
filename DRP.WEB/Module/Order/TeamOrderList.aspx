<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeamOrderList.aspx.cs" Inherits="DRP.WEB.Module.Order.TeamOrderList" %>
            ...
            <div title="企业团订单" runat="server" id="orderTitle" iconcls="icon-reload">
                <div id="toolbar">
                    ...
                    <div style="height: 25px; line-height: 25px; margin-top: 5px;">
                        ...
                        <a class="easyui-linkbutton" id="btnAdd" iconcls="icon-add">新增团队订单</a> <a class="easyui-linkbutton"
                            id="A1" iconcls="icon-add" onclick="o.fnBatchInvoice()">合并订单开票</a>

<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeBehind="TicetOrderInfo.aspx.cs" Inherits="DRP.WEB.Module.Order.TicetOrderInfo" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ClientIDMode="Static" ID="pnlWraper" CssClass="wrapper" runat="server">
            ...
            <table class="tblPrint">
                ...
                <asp:Repeater runat="server" ID="rptLog" OnItemDataBound="rptCustomer_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            <td style="text-align: center;">
                                <asp:Literal ID="lblNo" runat="server"></asp:Literal></td>

<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeBehind="OrderList.aspx.cs" Inherits="DRP.WEB.Module.Sales.OrderList" %>
...
<head runat="server">
    ...
    <script src="Script/OrderList.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        <div id="tabs" class="easyui-tabs">
            <div title="订单管理" runat="server" id="orderTitle" iconcls="icon-reload">
                <div id="toolbar">
                    ...
                    <div style="height: 25px; line-height: 25px; margin-top: 5px;">
                        ...
                        <asp:LinkButton ID="btnAdd" CssClass="easyui-linkbutton" iconcls="icon-add" ClientIDMode="Static" runat="server">新增同行散客订单</asp:LinkButton>

...
var c = {
    ...
    fnSave: function () { //提交决算单
        ...
        $.ajax({
            type: "post",
            url: c.url + "&action=11&r=" + getRand(),
            data: { "OrderID": orderID, "AdultNum": adultNum, "ChildNum": childNum, "OrderAmt": orderAmt, "CostItem": costItem, "Comment": comment, "DataStatus": "2", "BudgetStatus": "5", "FileID": fileIDs },

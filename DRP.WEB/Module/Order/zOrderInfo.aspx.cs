...
{
    public partial class zOrderInfo : Pagebase
    {
        ...
        private void BindData()
        {
            ...
            lnkToWord.NavigateUrl = "zToWord.aspx?id=" + e.ID;
            ...
            if (e != null)
            {
                ...
                rptPrice.DataSource = dal.GetOrderPrice(e.ID);
                rptPrice.DataBind();
                ...
                dal.GetOrderSeat(e.ID).ForEach(t =>
                {
                    seatNo.Add(t.SeatNum.ToString());
                });

                lblSeatNo.Text = "<tr><td colspan=\"7\">座位号：" + string.Join(",", seatNo) + "</td></tr>";

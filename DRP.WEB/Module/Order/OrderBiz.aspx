<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderBiz.aspx.cs" Inherits="DRP.WEB.Module.Order.OrderBiz" %>
...
<head runat="server">
    ...
    <script src="Script/OrderBiz.js" type="text/javascript"></script>
</head>
<body>
        ...
        <asp:Panel runat="server" ID="pnlContainer" Style="padding: 10px 5px;">
            <table class="tblInfo">
                ...
                <tr>
                    ...
                    <td class="rowlabel"><span class="red">*</span>订单日期：</td>
                    <td>
                        <asp:TextBox ID="TourDate" onclick="WdatePicker()" ClientIDMode="Static" runat="server" data-options="required:true"></asp:TextBox>
                    </td>
                    <td class="rowlabel">订单类型：</td>
                    <td>
                        <asp:DropDownList ID="SourceID" data-options="required:true" AppendDataBoundItems="true" runat="server">
                            <asp:ListItem Text="请选择"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td class="rowlabel">客户信息：</td>
                                ...
                                <asp:Repeater runat="server" ID="rptCustomer" OnItemDataBound="rptCustomer_ItemDataBound">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="textbox" style="width: 110px; height: 26px;" value='<%# Eval("Name") %>' />
                                            </td>
                                            <td>
                                                <asp:Literal ID="lblSex" runat="server"></asp:Literal></td>
                                            <td>
                                                <input type="text" class="textbox" style="width: 130px; height: 26px;" value='<%# Eval("Mobile") %>' /></td>
                                            <td>
